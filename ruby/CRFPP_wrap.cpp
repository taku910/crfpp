...
/*@SWIG:C:\dev\swigwin-3.0.8\Lib\ruby\rubyprimtypes.swg,19,%ruby_aux_method@*/
...
SWIGINTERN void
free_CRFPP_Model(void *self) {
    CRFPP::Model *arg1 = (CRFPP::Model *)self;
    delete arg1;
}
...
SWIGINTERN void
free_CRFPP_Tagger(void *self) {
    CRFPP::Tagger *arg1 = (CRFPP::Tagger *)self;
    delete arg1;
}
...
SWIGEXPORT void Init_CRFPP(void) {
  ...
  rb_define_const(mCRFPP, "VERSION", SWIG_FromCharPtr("0.59"));
}
