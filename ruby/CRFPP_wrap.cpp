...
/*@SWIG:/usr/share/swig/2.0.12/ruby/rubyprimtypes.swg,19,%ruby_aux_method@*/
...
_wrap_Model_createTagger(int argc, VALUE *argv, VALUE self) {
  ...
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_CRFPP__Tagger, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
